...
import 'package:proxy_actions_platform_interface/method_channel/method_channel_quick_actions.dart';
...
void main() {
  ...
  final ProxyActionsPlatform initialInstance = ProxyActionsPlatform.instance;

  group('$ProxyActionsPlatform', () {
    ...
    test('Cannot be implemented with `implements`', () {
      expect(() {
        ProxyActionsPlatform.instance = ImplementsQuickActionsPlatform();
    ...
    test('Can be extended', () {
      ProxyActionsPlatform.instance = ExtendsQuickActionsPlatform();
    });
...
class ImplementsQuickActionsPlatform implements ProxyActionsPlatform {
  @override
  dynamic noSuchMethod(Invocation invocation) => super.noSuchMethod(invocation);
}

class ExtendsQuickActionsPlatform extends ProxyActionsPlatform {}
