...
MethodChannel('plugins.flutter.io/proxy_actions_macos');

/// An implementation of [ProxyActionsPlatform] for MACOS.
class ProxyActionsMacos extends ProxyActionsPlatform {
  /// Registers this class as the default instance of [ProxyActionsPlatform].
  static void registerWith() {
    ProxyActionsPlatform.instance = ProxyActionsMacos();
  }
