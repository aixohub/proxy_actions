...
package android.src.main.java.io.flutter.plugins.quickactions;
...
/** QuickActionsPlugin */
public class ProxyActionsPlugin implements FlutterPlugin, ActivityAware, NewIntentListener {
  private static final String CHANNEL_ID = "plugins.flutter.io/proxy_actions_android";
  ...
  public static void registerWith(io.flutter.plugin.common.PluginRegistry.Registrar registrar) {
    final ProxyActionsPlugin plugin = new ProxyActionsPlugin();
