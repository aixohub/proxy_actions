...
import 'package:proxy_actions_platform_interface/proxy_actions_platform_interface.dart';

export 'package:proxy_actions_platform_interface/types/types.dart';

const MethodChannel _channel =
    MethodChannel('plugins.flutter.io/Proxy_actions_android');

/// An implementation of [ProxyActionsPlatform] that for Android.
class ProxyActionsAndroid extends ProxyActionsPlatform {
  /// Registers this class as the default instance of [ProxyActionsPlatform].
  static void registerWith() {
    ProxyActionsPlatform.instance = ProxyActionsAndroid();
  }
