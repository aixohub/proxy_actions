...
public final class ProxyActionsPlugin: NSObject, FlutterPlugin {

  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(
      name: "plugins.flutter.io/proxy_actions_ios",
      binaryMessenger: registrar.messenger())
    let instance = ProxyActionsPlugin(channel: channel)
  ...
  public func application(
      ...
      as? UIApplicationShortcutItem
    {
      ...
      // Return false to indicate we handled the Proxy action to ensure
